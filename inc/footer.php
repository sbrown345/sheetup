    ...
    <script type="text/javascript">var addthis_pub = "simonbrown33";</script>
...
sheetUp &ndash; simonbrown33 _At_ gmail _Dot_ com</div>
...
<?php if($_SERVER['HTTP_HOST'] != "localhost") { ?>
	...
	<script type="text/javascript">
	var pageTracker = _gat._getTracker("UA-5460797-2");
